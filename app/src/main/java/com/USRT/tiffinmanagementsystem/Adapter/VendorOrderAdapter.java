...
public class VendorOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<PlaceOrder> items = new ArrayList<>();

    private Context ctx;
    private VendorOrderAdapter.OnItemClickListener mOnItemClickListener;
    /*int hours;
    int min = 0;
    int days;
    long difference;*/
    ...
    public void setOnItemClickListener(final VendorOrderAdapter.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }



    public VendorOrderAdapter(Context context, List<PlaceOrder> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new VendorOrderAdapter.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof VendorOrderAdapter.OriginalViewHolder) {
            final VendorOrderAdapter.OriginalViewHolder view = (VendorOrderAdapter.OriginalViewHolder) holder;
